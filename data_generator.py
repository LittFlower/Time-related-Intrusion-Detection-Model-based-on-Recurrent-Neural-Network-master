...
os.makedirs(AE_1_dir, exist_ok=True)
...
os.makedirs(AE_2_dir, exist_ok=True)
...
os.makedirs(AE_3_dir, exist_ok=True)
...
reduc_lr = ReduceLROnPlateau(monitor='val_accuracy', patience=10, mode='max', factor=0.2, min_delta=1e-4)
